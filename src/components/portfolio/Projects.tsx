...
const ProjectCard = ({ project, index }: { project: any; index: number }) => {
  ...
  const color = project.color || "from-accent/20 to-accent/5";
        ...
        {open && (
          ...
          >
            ...
            >
              ...
              {project.image_url && <img src={project.image_url} alt="" className="w-full h-40 object-cover rounded-xl mb-4" />}
              ...
              <div className="flex gap-3">
                ...
                {project.demo_url && (
                  <a href={project.demo_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-full bg-primary text-primary-foreground text-sm font-medium hover:opacity-90">
